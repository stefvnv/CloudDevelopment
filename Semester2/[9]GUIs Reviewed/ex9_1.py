...
label4 = Label(frame, text="Value3", fg="blue", width=15, font=("arial", 10, "bold"))
...
list3Var = StringVar()
combo3 = OptionMenu(frame, list3Var, *list2)
list3Var.set("1")
combo3.grid(row=1, column=1, sticky=W+E)

list4 = ['1', '2', '3', '4', '5', '6', '7', '8', '9']
list4Var = StringVar()
combo4 = OptionMenu(frame, list4Var, *list2)
list4Var.set("1")
combo4.grid(row=2, column=1, sticky=W+E)

button5 = Button(frame, text="Add", fg="black", font=("arial", 10, "bold"), command=add)
button5.grid(row=4, column=0, sticky=W+E)

entry5 = Entry(frame)
entry5.insert(END, '')
entry5.grid(row=4, column=1, sticky=W+E)

button6 = Button(frame, text="Max", fg="black", font=("arial", 10, "bold"), command=maxi)
button6.grid(row=5, column=0, sticky=W+E)

entry6 = Entry(frame)
entry6.insert(END, '')
entry6.grid(row=5, column=1, sticky=W+E)

button61 = Button(frame, text="Clear", fg="black", font=("arial", 10, "bold"), command=clear)
button61.grid(row=6, column=0, sticky=W+E)

button62 = Button(frame, text="Exit", fg="black", font=("arial", 10, "bold"), command=myExit)
button62.grid(row=6, column=1, sticky=W+E)
