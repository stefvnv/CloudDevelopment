...
checkbox1 = IntVar()
checkbox1 = Checkbutton(window, text="Already 0", variable=checkbox1)
...
subm1.add_command(label="Increment", command=incr)
subm1.add_command(label="Decrement", command=decr)
